...
export default {
  ...
  methods: {
    getActorRoleList() {
      const _this = this;
      axios.get(_this.url + 'sysActorRole', {params: _this.queryInfo}).then(resp => {
        console.log(resp)
    ...
    addActorRole(){
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        await axios.post(_this.url + 'sysActorRole', JSON.stringify(_this.addForm)).then(resp => {
          console.log(resp)
    ...
    showEditDialog(id){
      const _this = this
      axios.get(_this.url + 'sysActorRole/' + id ).then(resp => {
        console.log(resp)
    ...
    editActorRoleInfo(){
      this.$refs.editFormRef.validate(async valid => {
        ...
        await axios.put(_this.url + '/sysActorRole', JSON.stringify(_this.editForm)).then(resp => {
          if (resp.data.code !== 200){
    ...
    async multipleDelete(){
      ...
      await axios.delete(_this.url + 'sysActorRole/' + ids).then(resp => {
        if (resp.data.code !== 200){
    ...
    async deleteActorRoleById(id){
      ...
      await axios.delete(_this.url + 'sysActorRole/' + id).then(resp => {
        if (resp.data.code !== 200){
