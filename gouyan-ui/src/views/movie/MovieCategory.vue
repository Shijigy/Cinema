...
export default {
  ...
  methods: {
    getMovieCategoryList() {
      const _this = this;
      axios.get(_this.url + 'sysMovieCategory', {params: _this.queryInfo}).then(resp => {
        console.log(resp)
    ...
    addMovieCategory(){
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        await axios.post(_this.url + 'sysMovieCategory', JSON.stringify(_this.addForm)).then(resp => {
          console.log(resp)
    ...
    showEditDialog(id){
      const _this = this
      axios.get(_this.url + 'sysMovieCategory/' + id ).then(resp => {
        console.log(resp)
    ...
    editMovieCategoryInfo(){
      this.$refs.editFormRef.validate(async valid => {
        ...
        await axios.put(_this.url + '/sysMovieCategory', JSON.stringify(_this.editForm)).then(resp => {
          if (resp.data.code !== 200){
    ...
    async multipleDelete(){
      ...
      await axios.delete(_this.url + 'sysMovieCategory/' + ids).then(resp => {
        if (resp.data.code !== 200){
    ...
    async deleteMovieCategoryById(id){
      ...
      await axios.delete(_this.url + 'sysMovieCategory/' + id).then(resp => {
        if (resp.data.code !== 200){
