<style scoped>
  ...
  <div>
    ...
    <el-card class="box-card">
      <el-row :gutter="20">
        <el-col :span="3">
          <el-button type="primary" @click="addDialogVisible = true">添加播放时段</el-button>
        </el-col>
        <el-col :span="2">
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改播放时段信息" placement="top" :enterable="false" :open-delay="500">
              <el-button type="primary" icon="el-icon-edit" size="mini" @click="showEditDialog(scope.row.movieRuntimeId)"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="删除播放时段" placement="top" :enterable="false" :open-delay="500">
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteMovieRuntimeById(scope.row.movieRuntimeId)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
